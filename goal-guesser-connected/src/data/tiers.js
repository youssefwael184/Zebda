...
export const TIERS = [
  { name: "Bronze", min: 800, max: 1199, icon: "🥉", color: "#CD7F32" }, // EASY
  { name: "Silver", min: 1200, max: 1499, icon: "🥈", color: "#C0C0C0" }, // MEDIUM
  { name: "Gold", min: 1500, max: 1999, icon: "🥇", color: "#FFD700" }, // HARD
  { name: "Platinum", min: 2000, max: 2299, icon: "💎", color: "#00d4ff" }, // LEGEND starts
  { name: "Diamond", min: 2300, max: 2599, icon: "💠", color: "#a78bfa" },
  { name: "Legend", min: 2600, max: 9999, icon: "👑", color: "#ef4444" },
];
...
export const DIFFICULTY_CONFIG = {
  ...
  medium: {
    ...
    bgClass: "bg-neon-amber/10",
    borderClass: "border-neon-amber/40",
  },
  hard: {
    label: "Hard",
    emoji: "🔥",
